...
u8 KEYPAD_getPressedKey(void)
{
	while(1)
	{
		for(u8 col = 0; col < KEYPAD_Columns; col++)
		{
			...
			GPIO_setPortdirection(KEYPAD_Port, INPUT);
...
/*Configure Keypad Output if it 4x4 */
#if KEYPAD_Columns == 4
	...
	static u8 Keypad_4x3Config(u8 btn)
	{
		...
		switch(button_number)
		{
			...
			case 16: replace_btn = '+'; /* ASCII Code of '+' */
					break;
			default: replace_btn = button_number;
					break;
		}
		return replace_btn;
	}
